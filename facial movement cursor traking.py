...
face_cascade = cv2.CascadeClassifier(r"C:\Users\HP\Desktop\Eye Motion Tracking\haarcascade_frontalface_alt.xml")
...
while True:
    ...
    for (x,y,w,h) in faces:
        ...
        for k,d in enumerate(detections): #For each detected face
            ...
            lcontours, lhierarchy = cv2.findContours(left_erosion,cv2.RETR_TREE,cv2.CHAIN_APPROX_NONE)
